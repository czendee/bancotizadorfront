        ...
        <div class="contenedor3 center">
            <div class="forma orde_det">
                <div class="d30 left_">    
                    ...
                    <h4 class="forma t_left">Datos fiscales</h4> 
                        <div class="forma mar_b_2">
                            <label class="forma">Nombre del cliente (Razón Social)</label>
                            <input type="text" class="t_left" name="" placeholder="Onda Gamma S.A de C.V."/>
                        </div>
                        <div class="forma mar_b_2">
                            <label class="forma">Giro MCC</label>
                        ...
                        <h4 class="forma t_left">Datos del contacto del comercios</h4> 
                        <div class="forma mar_b_2">
                            <label class="forma">Nombre y Apellidos</label>
                            <input type="text" class="t_left" name="" placeholder="Victor Erick Rodríguez Gil"/>
                        </div>
                        <div class="forma mar_b_2">
                            <label class="forma">E-mail</label>
                            <input type="text" class="t_left" name="" placeholder="erodriguez@ondagamma.com"/>
                        </div>
                        <div class="forma mar_b_2">
                        ...
                        <div class="forma mar_b_2">
                            <div class="forma">
                                <div class="d90 center">
                                    <div class="forma">
                                    <input type="submit" class="right_ mar_t_3 bot_value" value="GENERAR NUEVA COTIZACIÓN" />
                                    </div>
                                </div>
                            </div>
                ...
                <div class="d70 left_">
                    <div class="d90 right_">
                        <table class="forma terminales o_c_d mar_t_7">
                            <tbody class="forma">
                                <tr class="forma">
                                    <th class="t_left">
                                    MEDIO DE PAGO
