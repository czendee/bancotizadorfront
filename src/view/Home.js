...
var Changemonto= (e) => {
    ...
    setmonto_por_mes(monto_procesado);
 };   
...
var handleSubmit= (e) => {
    ...
    */
        ...
        if(nom_ap.current.value==''){
            ...
            $enviar = false;
            return $enviar; 
        }else if(validarSialpha(nom_ap.current.value) ){
...
function validarSialpha(letras){    
    if (!/^[a-zA-Z0-9\xc0-\xff ]+$/.test(letras)){
        return true;
    }else{
        return false;
    }
                ...
                <div className="forma">
                    ...
                    <div className="d50 left_ mov100">
                        <div className="d80 center">
                            ...
                            <input className="forma obligatorio" type="text"  name="p_web" id="p_web" ref={p_web}  maxlength="50" title='Por favor Ingrese Página web' />
                        </div>
                    </div>
