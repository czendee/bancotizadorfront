...
if(medio_de_pago1!== null ){
     ...
     content += '<td class="d25 left_ pad_none"><input type="number" class="inp_num" placeholder="'+(tazatarjeta_var)+'%"/></td>';
     content += '<td class="d25 left_ pad_none"><input type="number" class="inp_num" placeholder="$'+(tazatarjeta_fija)+'%"/></td>';
     content += '<td class="d25 left_ nopad"><select class="forma" name="Descuento Visa/MasterCard" id="dvm"><option>0%</option><option>5%</option><option>10%</option><option>15%</option></select> </td>';
     content += '</tr>';
...
if(medio_de_pago2!== null ){
     ...
     content += '<td class="d25 left_ pad_none"><input type="number" class="inp_num" placeholder="'+(tazaamex_var)+'%"/></td>';
     content += '<td class="d25 left_ pad_none"><input type="number" class="inp_num" placeholder="$'+(tazaamex_fija)+'"/></td>';
     content += '<td class="d25 left_ nopad"><select class="forma" name="Descuento AMEX" id="damx" value=""><option>0%</option><option>5%</option><option>10%</option><option>15%</option></select></td>';
     content += '</tr>';
...
if(medio_de_pago3!== null ){
     ...
     content += '<td class="d25 left_ pad_none"><input type="number" class="inp_num" placeholder="'+(tazaoxxo_var)+'%"/></td>';
     content += '<td class="d25 left_ pad_none"><input type="number" class="inp_num" placeholder="$'+(tazaoxxo_fija)+'"/></td>';
     content += '<td class="d25 left_ nopad"><select class="forma" name="Descuento OXXO" id="dox" ><option>0%</option><option>5%</option><option>10%</option><option>15%</option></select></td>';
     content += '</tr>';
...
if(medio_de_pago4!== null ){
     ...
     content += '<td class="d25 left_ pad_none"><input type="number" class="inp_num" placeholder="'+(tazapaycash_var)+'%"/></td>';
     content += '<td class="d25 left_ pad_none"><input type="number" class="inp_num" placeholder="$'+(tazapaycash_fija)+'"/></td>';
     content += '<td class="d25 left_ nopad"><select class="forma" name="Descuento Paycash" id="dpy"><option>0%</option><option>5%</option><option>10%</option><option>15%</option></select></td>';   
     content += '</tr>';    
...
if(medio_de_pago5!== null ){
     ...
     content += '<td class="d25 left_ pad_none"><input type="number" class="inp_num" placeholder="'+(tazaspei_var)+'%"/></td>';
     content += '<td class="d25 left_ pad_none"><input type="number" class="inp_num" placeholder="$'+(tazaspei_fija)+'"/></td>';
     content += '<td class="d25 left_ nopad"><select class="forma" name="Descuento SPEI" id="dspi" ><option>0%</option><option>5%</option><option>10%</option><option>15%</option></select></td>';
     content += '</tr>';    
     ...
     content += '<td class="d25 left_ pad_none"><input type="number" class="inp_num" placeholder="'+(tazastorepay_var)+'%"/></td>';
     content += '<td class="d25 left_ pad_none"><input type="number" class="inp_num" placeholder="$'+(tazastorepay_fija)+'"/></td>';
     content += '<td class="d25 left_ nopad"><select class="forma" name="Descuento Store Pay" id="dstp" ><option>0%</option><option>5%</option><option>10%</option><option>15%</option></select></td>';
     content += '</tr>';
                ...
                <div className="forma">
                    ...
                    <div className="forma">
                        ...
                        <div className="forma mar_t_10 mar_b_10">
                            <input type="button" className="cotizar" id='propuesta' value="PROPUESTA" onClick={gettypicodeInfo}/>
                        </div>
                    </div>
                </div>
